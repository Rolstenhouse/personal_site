...
\item[]
    ...
    \begin{itemize}
        % \resitem{Conducted research, synthesized results, implemented and shipped internal tool yielding a 15x performance improvement for operations and developers}
