...
\begin{itemize}
\item
	\ressubheading{Nextdoor (KPCB Engineering Fellow)}{San Francisco, CA}{Software Engineering Intern}{May 2017 - Aug. 2017}
	\begin{itemize}
	\end{itemize}
\item
...
\begin{description}
\textbf{Languages:} \tabto{2.5cm} Python, JavaScript, VHDL, C, asm, Java, C{}\verb!++!, TypeScript, PHP, C\#, .NET, Git\newline
